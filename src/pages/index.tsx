  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless tool rentals with Construction Tool Rental v1, your central supplier with multiple outlets. Empowering individuals to build with ease."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless tool rentals with Construction Tool Rental v1, your central supplier with multiple outlets. Empowering individuals to build with ease.`}
            </Text>
            <Box
